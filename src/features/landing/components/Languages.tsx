    ...
    <section id="languages" className="py-14 lg:py-20">
      <div className="mono-container">
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2">
          <div
            lang="en"
            className="relative rounded-[4px] border-[1.5px] border-ink bg-paper-2 p-8 shadow-mono"
          >
          ...
          <div
            lang="ar"
            dir="rtl"
            className="relative rotate-[-0.6deg] rounded-[4px] border-[1.5px] border-ink bg-paper-2 p-8 shadow-mono"
          >
            <span className="mono-display mb-6 inline-flex w-max items-center gap-2.5 rounded-[4px] border-[1.5px] border-ink bg-paper px-3 py-1.5 text-xl">
