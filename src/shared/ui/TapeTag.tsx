...
export function TapeTag({
  ...
  return (
    <span
      className={`vexa-display inline-block rotate-[2deg] rounded-sm bg-vexa-tape px-3 py-1 text-base leading-none text-ink backdrop-blur-[2px] shadow-sm ${className}`}
    >
      {children}
    </span>
  );
